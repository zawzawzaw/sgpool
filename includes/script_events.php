  ...
  <?php if ($is_debug == true): ?>
    ...
    <!-- Google Map -->    
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBpoMgmnh8t45ud6iYzdzybZyJXPIrSBn0" async defer></script>
    ...
    <script type="text/javascript">
      goog.require('sgpool.page.Events');
    </script>
  ...
  <?php else: ?>
    ...
    <script type="text/javascript">
      ...
      var PAGE_LIBRARY        = "sgpool_assets/js/minified/libraries-events.min.js";
      var PAGE_JS             = "sgpool_assets/js/minified/page-events.min.js";
      ...
      window.head_js.load(PAGE_LIBRARY, function() {
        window.head_js.load(PAGE_JS, function() {
          window.page = new sgpool.page.Events({});
        });
      });
    </script>
