  ...
  <?php if ($is_debug == true): ?>
    ...
    <script type="text/javascript" src="sgpool_assets/libs/wow/wow.min.js"></script>
  ...
  <?php else: ?>
    ...
    <script type="text/javascript">
      ...
      var PAGE_LIBRARY        = "sgpool_assets/js/minified/libraries-home.min.js";
      var PAGE_JS             = "sgpool_assets/js/minified/page-home.min.js";
      ...
      window.head_js.load(PAGE_LIBRARY, function() {
        window.head_js.load(PAGE_JS, function() {
          window.page = new sgpool.page.Home({});
        });
      });
    </script>
