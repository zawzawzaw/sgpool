  ...
  <?php if ($is_debug == true): ?>
    ...
    <script type="text/javascript">
      goog.require('sgpool.page.Milestones_Org');
    </script>
    ...
    <script type="text/javascript">
      ...
      jQuery(document).ready(function($) {
        page = new sgpool.page.Milestones_Org({});
      });
  ...
  <?php else: ?>
    ...
    <script type="text/javascript">
      ...
      var PAGE_JS             = "sgpool_assets/js/minified/page-milestones-org.min.js";
      ...
      window.head_js.load(PAGE_LIBRARY, function() {
        window.head_js.load(PAGE_JS, function() {
          window.page = new sgpool.page.Milestones_Org({});
        });
      });
    </script>
