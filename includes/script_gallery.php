  ...
  <?php if ($is_debug == true): ?>
    ...
    <script type="text/javascript">
      goog.require('sgpool.page.Gallery');
    </script>
  ...
  <?php else: ?>
    ...
    <script type="text/javascript">
      ...
      var PAGE_LIBRARY        = "sgpool_assets/js/minified/libraries-gallery.min.js";
      var PAGE_JS             = "sgpool_assets/js/minified/page-gallery.min.js";
      ...
      window.head_js.load(PAGE_LIBRARY, function() {
        window.head_js.load(PAGE_JS, function() {
          window.page = new sgpool.page.Gallery({});
        });
      });
    </script>
