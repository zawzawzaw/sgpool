goog.provide('sgpool.page.Milestones');
 ...
 */
sgpool.page.Milestones = function(options, element) {

  sgpool.page.Default.call(this, options, element);
  this.options = $.extend(this.options, sgpool.page.Milestones.DEFAULT, options);


  console.log('sgpool.page.Milestones: init');
};
goog.inherits(sgpool.page.Milestones, sgpool.page.Default);
 ...
 * @const {object}
 */
sgpool.page.Milestones.DEFAULT = {
};
 ...
 * @type {string}
 */
sgpool.page.Milestones.EVENT_01 = '';
 ...
 * @inheritDoc
 */
sgpool.page.Milestones.prototype.init = function() {
  sgpool.page.Milestones.superClass_.init.call(this);
...
sgpool.page.Milestones.prototype.create_page_indicators = function() {
...
sgpool.page.Milestones.prototype.create_page_indicators_mobile = function() {
...
sgpool.page.Milestones.prototype.create_page_transitions = function() {
...
sgpool.page.Milestones.prototype.public_method_01 = function() {};
 ...
 * @param {object} event
 */
sgpool.page.Milestones.prototype.on_event_handler_02 = function(event) {
};



sgpool.page.Milestones.prototype.sample_method_calls = function() {

  // sample override
  sgpool.page.Milestones.superClass_.method_02.call(this);

  // sample event
  this.dispatchEvent(new goog.events.Event(sgpool.page.Milestones.EVENT_01));
};
 ...
 * @inheritDoc
 */
sgpool.page.Milestones.prototype.update_page_layout = function() {

  sgpool.page.Milestones.superClass_.update_page_layout.call(this);
 ...
 * @inheritDoc
 */
sgpool.page.Milestones.prototype.scroll_to_target = function(str_param, str_param_2, str_param_3) {
  sgpool.page.Milestones.superClass_.scroll_to_target.call(this, str_param, str_param_2, str_param_3);
 ...
 * @inheritDoc
 */
sgpool.page.Milestones.prototype.on_scroll_to_no_target = function() {
  sgpool.page.Milestones.superClass_.on_scroll_to_no_target.call(this);
...
goog.exportSymbol('sgpool.page.Milestones', sgpool.page.Milestones);